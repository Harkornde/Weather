      ...
      <div className="flex items-center justify-between px-2 py-4 bg-[#03012d] w-9/10 md:w-8/10 fixed top-0 left-1/2 -translate-x-1/2">
        ...
        <div className="absolute mr-2 p-2 right-0 top-14 bg-[#312f4b] w-47 rounded-md ">
          ...
          <div>
            ...
            <button className="mt-1 block">Celcius(°C)</button>
            <button className="mt-1">Fahrenheit(°F)</button>
          </div>

          {/* Building the Wind speed */}
          <div>
            <p className="text-sm text-[#aeaeb7]">Wind speed</p>
            <button className="mt-1 block">Km/h</button>
            <button className="mt-1">mph</button>
          </div>
